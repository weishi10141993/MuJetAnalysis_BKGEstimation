...
void PlotBBbar() {
  ...
  txtHeader->SetHeader("CMS Prelim. 2012  #sqrt{s} = 13 TeV   L_{int} = ~ pb^{-1}");
  ...
  h1_ds_dimuorphan_bg_m1->GetYaxis()->SetRangeUser(0.,1600.);
  ...
  h1_ds_dimuorphan_bg_m2->GetYaxis()->SetRangeUser(0.,600.);
  ...
  h1_control_offDiagonal_massC_data->GetYaxis()->SetRangeUser(0.,150.);
  ...
  h1_control_offDiagonal_massF_data->GetYaxis()->SetRangeUser(0.,150.);
  ...
  h1_control_offDiagonal_data->GetYaxis()->SetRangeUser(0.,150.);
  ...
  h1_control_offDiagonal_Jpsi->GetYaxis()->SetRangeUser(0.,150.);
