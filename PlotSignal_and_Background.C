...
void PlotSignal_and_Background() {
  ...
  txtHeader->SetHeader("CMS Prelim. 2015D  #sqrt{s} = 8 TeV   L_{int} = ~ pb^{-1}");
  ...
  txtHeader_lumi->SetHeader("~ pb^{-1} (13 TeV)");
...
////  h2_dimudimu_control_Iso_offDiagonal_2D_tmp->SetMarkerSize(2.0);
  ...
  h2_dimudimu_control_Iso_offDiagonal_2D_points->Fill(1.2642663, 2.2951393);
  ...
  h2_dimudimu_control_Iso_offDiagonal_2D_points_tmp->Fill(1.2642663, 2.2951393);
  ...
  //h2_signal->Fill(0.3292791, 0.2173234);
