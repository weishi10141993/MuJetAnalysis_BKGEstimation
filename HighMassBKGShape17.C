...
//* Run it as: root -l -b -q HighMassBKGShape17.C                                                 *
...
void HighMassBKGShape17()
{
  ...
  MC_hs_CR_m1->Draw("HIST"); MC_hs_CR_m1->SetMaximum(200); MC_hs_CR_m1->GetYaxis()->SetTitle("Events/4GeV");
  //Plot MC error
  ...
  CR2pad1->cd();
  //Plot stacked histogram from MC
  MC_hs_CR_m2->Draw("HIST"); MC_hs_CR_m2->SetMaximum(200); MC_hs_CR_m2->GetYaxis()->SetTitle("Events/4GeV");
  //Plot MC error
