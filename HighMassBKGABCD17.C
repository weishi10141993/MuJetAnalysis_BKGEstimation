...
void HighMassBKGABCD17() {
  ...
  for (int i = 0; i < 29; i++) {
    ...
    //=====================================
    //new selection allow at most 1 SAmu,
    //to be replaced by new HLT
    //=====================================
    stream_cut_B << "is1SelMu17 && is2SelMu8 && is3SelMu8 && is4SelMu8 && isVertexOK && is2DiMuons && nSAMu <= 1 && diMuonC_FittedVtx_prob > 0.18*(1 - dimuC_nSAMu)*exp( -( 0.099 + 0.115*diMuonC_FittedVtx_dR + 0.311*pow(diMuonC_FittedVtx_dR, 2) + 0.074*pow(diMuonC_FittedVtx_dR, 3) )*fabs(diMuonC_FittedVtx_Lxy/2.9) ) && diMuonF_FittedVtx_prob > 0.18*(1 - dimuF_nSAMu)*exp( -( 0.099 + 0.115*diMuonF_FittedVtx_dR + 0.311*pow(diMuonF_FittedVtx_dR, 2) + 0.074*pow(diMuonF_FittedVtx_dR, 3) )*fabs(diMuonF_FittedVtx_Lxy/2.9) ) && ( nSAMu == 0 || (dimuC_nSAMu == 1 && diMuonC_FittedVtx_Lxy > 0.1) || (dimuF_nSAMu == 1 && diMuonF_FittedVtx_Lxy > 0.1) ) && (recoRePaired2mutrailing_dR >= 0.2 || recoRePaired2mutrailing_m >= 3) && (diMuonC_m1_FittedVtx_hitpix_Phase1 == 1 || diMuonC_m2_FittedVtx_hitpix_Phase1 == 1) && (diMuonF_m1_FittedVtx_hitpix_Phase1 == 1 || diMuonF_m2_FittedVtx_hitpix_Phase1 == 1) && isSignalHLTFired && TMath::Max(diMuonC_IsoTk_FittedVtx,diMuonF_IsoTk_FittedVtx)<"<< VarY[i] <<" && TMath::Max(diMuonC_IsoTk_FittedVtx,diMuonF_IsoTk_FittedVtx)>="<< iso_cut <<" && fabs(massC-massF)-3*0.007025*(massC+massF)/2.0-3*0.000053*(massC+massF)*(massC+massF)/4.0<0.009132 && massC>11. && massC<59. && massF>11. && massF<59.";
    ...
    //to be replaced by new HLT
    //=====================================
    stream_cut_C << "is1SelMu17 && is2SelMu8 && is3SelMu8 && is4SelMu8 && isVertexOK && is2DiMuons && nSAMu <= 1 && diMuonC_FittedVtx_prob > 0.18*(1 - dimuC_nSAMu)*exp( -( 0.099 + 0.115*diMuonC_FittedVtx_dR + 0.311*pow(diMuonC_FittedVtx_dR, 2) + 0.074*pow(diMuonC_FittedVtx_dR, 3) )*fabs(diMuonC_FittedVtx_Lxy/2.9) ) && diMuonF_FittedVtx_prob > 0.18*(1 - dimuF_nSAMu)*exp( -( 0.099 + 0.115*diMuonF_FittedVtx_dR + 0.311*pow(diMuonF_FittedVtx_dR, 2) + 0.074*pow(diMuonF_FittedVtx_dR, 3) )*fabs(diMuonF_FittedVtx_Lxy/2.9) ) && ( nSAMu == 0 || (dimuC_nSAMu == 1 && diMuonC_FittedVtx_Lxy > 0.1) || (dimuF_nSAMu == 1 && diMuonF_FittedVtx_Lxy > 0.1) ) && (recoRePaired2mutrailing_dR >= 0.2 || recoRePaired2mutrailing_m >= 3) && (diMuonC_m1_FittedVtx_hitpix_Phase1 == 1 || diMuonC_m2_FittedVtx_hitpix_Phase1 == 1) && (diMuonF_m1_FittedVtx_hitpix_Phase1 == 1 || diMuonF_m2_FittedVtx_hitpix_Phase1 == 1) && isSignalHLTFired && TMath::Max(diMuonC_IsoTk_FittedVtx,diMuonF_IsoTk_FittedVtx)<"<< VarY[i] <<" && TMath::Max(diMuonC_IsoTk_FittedVtx,diMuonF_IsoTk_FittedVtx)>="<< iso_cut <<" && fabs(massC-massF)-3*0.007025*(massC+massF)/2.0-3*0.000053*(massC+massF)*(massC+massF)/4.0<"<< VarX[i] <<" && fabs(massC-massF)-3*0.007025*(massC+massF)/2.0-3*0.000053*(massC+massF)*(massC+massF)/4.0>=0.009132 && massC>11. && massC<59. && massF>11. && massF<59.";
    ...
    //to be replaced by new HLT
    //=====================================
    stream_cut_D << "is1SelMu17 && is2SelMu8 && is3SelMu8 && is4SelMu8 && isVertexOK && is2DiMuons && nSAMu <= 1 && diMuonC_FittedVtx_prob > 0.18*(1 - dimuC_nSAMu)*exp( -( 0.099 + 0.115*diMuonC_FittedVtx_dR + 0.311*pow(diMuonC_FittedVtx_dR, 2) + 0.074*pow(diMuonC_FittedVtx_dR, 3) )*fabs(diMuonC_FittedVtx_Lxy/2.9) ) && diMuonF_FittedVtx_prob > 0.18*(1 - dimuF_nSAMu)*exp( -( 0.099 + 0.115*diMuonF_FittedVtx_dR + 0.311*pow(diMuonF_FittedVtx_dR, 2) + 0.074*pow(diMuonF_FittedVtx_dR, 3) )*fabs(diMuonF_FittedVtx_Lxy/2.9) ) && ( nSAMu == 0 || (dimuC_nSAMu == 1 && diMuonC_FittedVtx_Lxy > 0.1) || (dimuF_nSAMu == 1 && diMuonF_FittedVtx_Lxy > 0.1) ) && (recoRePaired2mutrailing_dR >= 0.2 || recoRePaired2mutrailing_m >= 3) && (diMuonC_m1_FittedVtx_hitpix_Phase1 == 1 || diMuonC_m2_FittedVtx_hitpix_Phase1 == 1) && (diMuonF_m1_FittedVtx_hitpix_Phase1 == 1 || diMuonF_m2_FittedVtx_hitpix_Phase1 == 1) && isSignalHLTFired && TMath::Max(diMuonC_IsoTk_FittedVtx,diMuonF_IsoTk_FittedVtx)<"<< iso_cut <<" && fabs(massC-massF)-3*0.007025*(massC+massF)/2.0-3*0.000053*(massC+massF)*(massC+massF)/4.0<"<< VarX[i] <<" && fabs(massC-massF)-3*0.007025*(massC+massF)/2.0-3*0.000053*(massC+massF)*(massC+massF)/4.0>=0.009132 && massC>11. && massC<59. && massF>11. && massF<59.";
